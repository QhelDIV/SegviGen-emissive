#!/usr/bin/env python3
"""Publish web/_preview/fig7_segvigen/ to the aspis web root by MERGE-COPY.
...
Live URL: https://aspis.cmpt.sfu.ca/projects/omages/yanxg/lightgen/_preview/fig7_segvigen/
...
DEST = os.path.join(WWW, "_preview", "fig7_segvigen")
