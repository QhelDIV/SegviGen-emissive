#!/usr/bin/env python3
"""Publish web/_preview/ckpt4_eval/ to the aspis web root by MERGE-COPY.
...
Live URL: https://aspis.cmpt.sfu.ca/projects/omages/yanxg/lightgen/_preview/ckpt4_eval/

Run: /project/3dlg-hcvc/omages/omages_internal/.venv2/bin/python \
        web/_preview/ckpt4_eval/publish.py
"""
import os
import shutil
...
DEST = os.path.join(WWW, "_preview", "ckpt4_eval")
