#!/usr/bin/env python3
"""Publish web/_preview/fullseg_19/ to the aspis web root by MERGE-COPY.
...
Live URL: https://aspis.cmpt.sfu.ca/projects/omages/yanxg/lightgen/_preview/fullseg_19/

Run: /local-scratch2/xya120/studio/misc/lightgen/.venv_console/bin/python \
        web/_preview/fullseg_19/publish.py
"""
import os
import shutil
...
DEST = os.path.join(WWW, "_preview", "fullseg_19")
